...
func (s *PostProcessService) validateDirectoryCoverageTx(
	ctx context.Context,
	tx *sql.Tx,
	required map[directoryCategory]bool,
	counts map[directoryCategory]int,
...
func (s *PostProcessService) commitDirectoryTx(
	ctx context.Context,
	tx *sql.Tx,
...
func (s *PostProcessService) applyHistoryChange(
	ctx context.Context,
	tx *sql.Tx,
	task repository.WorkerTask,
...
func (s *PostProcessService) finishNoNewDataHistory(
	ctx context.Context,
	tx *sql.Tx,
	task repository.WorkerTask,
	payload AssetHistorySyncPayload,
...
func (s *PostProcessService) fxInstruments(
...
func (s *PostProcessService) processFXPairTx(
	ctx context.Context,
	tx *sql.Tx,
	task repository.WorkerTask,
	rawPair string,
