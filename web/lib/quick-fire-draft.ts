...
export function consumeQuickFireTransfer(storage: Storage | null): QuickFireTransferInput | null {
  ...
  try {
    ...
    return isQuickFireInput(input) ? candidate as QuickFireTransferInput : null;
  } catch {
    return null;
  }
}
